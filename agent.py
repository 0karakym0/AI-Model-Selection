...
Формат ответа — ровно четыре блока. Пиши кратко, по делу. Не обрывай ответ на полуслове, всегда завершай полностью.
...
Отвечай на русском языке. Завершай ответ полностью. Будь полезным, точным и профессиональным.
"""
